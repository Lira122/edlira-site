import{t as h,k as y}from"./index-DCHBfG7e.js";let n=[],d="inicio",o={},c=!1;const p=[{lbl:'👋 "Oi"',txt:"Oi"},{lbl:'🙋 "Tudo bem? Quem fala?"',txt:"Tudo bem? Quem fala?"},{lbl:'🤔 "Por que está me chamando?"',txt:"Por que tá me chamando?"},{lbl:"🏪 Lead engajado",txt:"Oi! Sou a Maria, tenho uma loja de roupa aqui em Taubaté. Conta mais."},{lbl:"😒 Lead frio",txt:"Não tô interessado em nada, valeu"},{lbl:"💰 Pergunta preço",txt:"Quanto vocês cobram?"},{lbl:"🤖 Desconfia bot",txt:"Isso é um bot né?"},{lbl:"🏁 Lead encerrou negócio",txt:"Vendi a empresa ano passado, tô aposentado"}];async function k(){const e=document.getElementById("content");e.innerHTML=x(),E(e)}function x(){return`
  <div class="tb">
    <div class="tb-side">
      <div class="tb-block">
